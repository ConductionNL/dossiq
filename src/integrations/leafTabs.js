...
// `lib/Service/Integration/Providers/` (FormsProvider, PhotosProvider,
// CalendarProvider, MapsProvider, …). Their matching Vue surfaces
// (CnFormsTab, CnPhotosTab, CnCalendarTab, CnMapsTab) live in
