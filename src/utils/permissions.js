 ...
 * integration rows live in OpenRegister, `GET
 * /apps/openregister/api/objects/dossiq/dossiqIntegration` answers them to any
 * authenticated account, and the `dossiqIntegration` schema declares no
 * `authorization` block to change that. Closing that is an OpenRegister schema
 * change and it is tracked separately — nothing here should be read as having
 * closed it.
 *
