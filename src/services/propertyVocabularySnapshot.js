...
export const VOCABULARY_SNAPSHOT = {
	...
	"modifiers": [
	 ...
	 },
	 {
	  ...
	  "value": "boolean",
	  "enforced": true,
	  "description": "Set this to false and the property disappears from every read."
	 },
	 {
	 ...
	 },
	 {
	  ...
	  "value": "string",
	  "enforced": true,
	  "description": "Which language the authored value is in. Needs translatable."
	 },
	 {
	  "key": "calculation",
	  "value": "object",
	  "enforced": true,
	  "description": "Derive the value from other properties instead of asking for it."
	 },
	 {
	  "key": "computed",
	  "value": "string",
	 ...
	 },
	 {
	  ...
	  "value": "string",
	  "enforced": true,
	  "description": "What happens to this object when the one it points at is deleted."
	 },
	 {
	  "key": "cascade",
	  "value": "boolean",
	...
	"passthrough": [
	 ...
	 },
	 {
	  "key": "allOf",
	  "enforced": false,
	  "description": "Every listed shape has to match. Stored, not enforced here."
	 },
	 {
	  "key": "anyOf",
	  "enforced": false,
	  "description": "At least one listed shape has to match. Stored, not enforced here."
	 },
	 {
	  "key": "not",
	  "enforced": false,
	  "description": "The listed shape must not match. Stored, not enforced here."
	 },
	 {
	  "key": "if",
	  "enforced": false,
	 ...
	 },
	 {
	  ...
	  "enforced": false,
	  "description": "Nested properties matched by name against a regular expression."
	 },
	 {
	  "key": "propertyNames",
	  "enforced": false,
	 ...
	 },
	 {
	  ...
	  "enforced": false,
	  "description": "Which properties become required once this one is answered."
	 },
	 {
