	...
	<div class="email-settings">
		<NcNoteCard type="info">
			{{
				t(
					'dossiq',
					'Configure the shared functional mailbox (e.g. zaken@gemeente.nl) that the inbound poller reads and links to cases by [ZAAK-YYYY-NNNNNN] subject tag. Outbound mail and per-user accounts are owned by Nextcloud Mail. They are not configured here.',
				)
			}}
		</NcNoteCard>
