...
/**
 * OpenRegister PersonLinkUpdatedEvent stub.
 *
 * Declaration-only mirror of OpenRegister's people-on-objects event contract
 * (`lib/Event/PersonLinkUpdatedEvent.php`, change `people-on-objects`), the same
...
/**
 * A person's link on an object changed.
 */
class PersonLinkUpdatedEvent extends Event {
