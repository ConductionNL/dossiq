...
/**
 * Decidiq DecisionConcludedEvent test stub.
 *
 * Mirrors decidiq's merged event contract so dossiq's
 * DecisionConcludedListener can be unit-tested without the decidiq app
 * installed. The real class ships in decidiq
 * (`OCA\Decidiq\Event\DecisionConcludedEvent`); this stub is loaded by
