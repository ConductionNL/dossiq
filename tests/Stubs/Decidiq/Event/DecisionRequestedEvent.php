...
/**
 * Decidiq DecisionRequestedEvent test stub.
 *
 * Mirrors decidiq's merged event contract so dossiq's delegation services can
 * be unit-tested without the decidiq app installed. The real class ships in
 * decidiq (`OCA\Decidiq\Event\DecisionRequestedEvent`); this stub is loaded
