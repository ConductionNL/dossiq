...
/**
 * DossiqCaseAuthorizer Unit Tests
 *
 ...
 * @spec openspec/specs/mcp-integration/spec.md
 */
class StubbedRoleSearchAuthorizer extends DossiqCaseAuthorizer {
	/**
	 ...
	 * @param SettingsService $settingsService The Dossiq settings service.
...
/**
 * Unit tests for DossiqCaseAuthorizer::canReadCase().
 *
 * @spec openspec/specs/mcp-integration/spec.md
 */
class DossiqCaseAuthorizerTest extends TestCase {
	/**
