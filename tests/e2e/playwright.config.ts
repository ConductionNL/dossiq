	...
	projects: [
		{
			...
			// PROOF BRANCH ONLY: the four specs whose teardown timed out.
			testMatch: [
				'**/case-list-lenses.spec.ts',
				'**/case-lifecycle-on-the-page.spec.ts',
				'**/checklist-per-status.spec.ts',
				'**/spec-coverage/queue.spec.ts',
			],
