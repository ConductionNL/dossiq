OC.L10N.register(
    ...
    "Compliance by Case Type" : "Compliance per zaaktype",
    ...
    "No case data available for processing time analysis." : "Geen zaakgegevens beschikbaar voor analyseering van verwerkingstijd.",
    "No cases found" : "Geen zaken gevonden",
    "No completed cases in the selected date range." : "Geen afgeronde zaken in het geselecteerde datumbereik.",
    ...
    "No SLA targets configured. Set processing deadlines on case types in Settings to enable compliance tracking." : "Geen SLA-doelen geconfigureerd. Stel verwerkingsdeadlines in op zaaktypen in Instellingen om compliancebijhouding in te schakelen.",
    ...
    "Processing Time Analytics" : "Analyseering verwerkingstijd",
    "Processing Time Distribution" : "Verdeling verwerkingstijd",
    "Processing time" : "Verwerkingstijd",
    "Processing time (days)" : "Verwerkingstijd (dagen)",
    "Procest" : "Procest",
    ...
    "Set result" : "Resultaat instellen",
    ...
    "SLA adherence and processing time analysis" : "SLA-naleving en analyseering verwerkingstijd",
    ...
    "by {user}" : "door {user}",
    "cases" : "zaken",
    "cases near or past deadline" : "zaken dicht bij of voorbij deadline",
    "completed" : "afgerond",
