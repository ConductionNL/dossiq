OC.L10N.register(
    ...
    "Appointment is already cancelled" : "Appointment is already cancelled",
    ...
    "Besluit mapping not configured" : "Besluit mapping not configured",
    "CASE" : "CASE",
    ...
    "Case cannot be closed: not all information objects have indicatieGebruiksrecht set." : "Case cannot be closed: not all information objects have indicatieGebruiksrecht set.",
    ...
    "Comment must not be empty" : "Comment must not be empty",
    "Complete" : "Complete",
    "Completed" : "Completed",
    ...
    "Confirm" : "Confirm",
    "Consumer service not available" : "Consumer service not available",
    ...
    "Document mapping not configured" : "Document mapping not configured",
    ...
    "Invalid mapping result" : "Invalid mapping result",
    ...
    "No permission to comment" : "No permission to comment",
    ...
    "The communicatiekanaal URL is invalid." : "The communicatiekanaal URL is invalid.",
