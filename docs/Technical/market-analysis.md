...
The gap register puts these and the rest into **161 gaps** with one owner each, 34 on dossiq and 69 on openregister. 150 of them name the OpenSpec change that carries them, across 83 changes in nine repositories, and the eleven that do not each say why. The [result page](../research/competitor-parity-2026-09.md#the-gap-register-counted-by-owner) has the counts by owner, and the umbrella the dossiq changes, [33 at first](https://github.com/ConductionNL/dossiq/pull/2643) and [five more](https://github.com/ConductionNL/dossiq/pull/2684).
...
| Non-Dutch products outscore dossiq on the comparable half | OTOBO 78, Odoo 78, Znuny 73 and Frappe Helpdesk 72 against 71; Easy Redmine 86 and JSM 83 as documented ceilings | The gap register: 161 gaps, 103 of them size S, 150 carried by a named OpenSpec change |
...
| OpenRegister dependency | 69 of 161 gaps, and 280 of the 636 discovery candidates, are owned by openregister | The [openregister umbrella](https://github.com/ConductionNL/openregister/pull/3688) carries them; dossiq keeps a half on each |
