...
Seed objects to load via `lib/Settings/procest_register.json`. All Dutch values; UUIDs are placeholders to be replaced at load time.
...
```json
{
  ...
  "description": "Zaaktype voor omgevingsvergunningaanvragen ingediend via DSO Omgevingsloket (Omgevingswet 2024)",
  "trigger": "Indiening vergunningaanvraag via DSO-LV Omgevingsloket",
  "processingDeadline": "P56D",
  "extensionAllowed": true,
  "extensionPeriod": "P182D",
  "publicationRequired": true,
  "internalOrExternal": "extern",
  "origin": "indienen",
  "confidentiality": "openbaar",
  "responsible": "Afdeling VTH"
}
```

### statusType — vijf lifecycle-fasen

```json
[
  { "name": "Ingediend",      "description": "Vergunningaanvraag ontvangen via DSO-LV; nog niet in behandeling",       "order": 1, "isFinal": false },
  { "name": "In behandeling", "description": "Aanvraag is in behandeling genomen bij het bevoegd gezag",                "order": 2, "isFinal": false },
  { "name": "Verleend",       "description": "Omgevingsvergunning verleend; beschikking verzonden aan initiatiefnemer", "order": 3, "isFinal": true  },
  { "name": "Geweigerd",      "description": "Omgevingsvergunning geweigerd; beschikking met motivering verzonden",     "order": 4, "isFinal": true  },
  { "name": "Ingetrokken",    "description": "Aanvraag ingetrokken door initiatiefnemer vóór besluitvorming",          "order": 5, "isFinal": true  }
]
```

### case — vier voorbeeldzaken

```json
[
  {
    "title": "Aanvraag dakkapel Keizersgracht 123, Amsterdam",
    "identifier": "2026-OV-0001",
    "caseType": "@omgevingsvergunning",
    ...
    "deadlineDatum": "2026-05-10",
    "bevoegdGezag": "Gemeente Amsterdam",
    "sourceOrganisation": "00000001002220647000"
  },
  {
    "title": "Uitbreiding bedrijfspand Binckhorstlaan 36, Den Haag",
    "identifier": "2026-OV-0002",
    "caseType": "@omgevingsvergunning",
    "status": "ingediend",
    "startDate": "2026-04-02",
    "plannedEndDate": "2026-12-15",
    "deadline": "2026-12-15",
    "vergunningaanvraagRef": "nl.dso.aanvraag.2026-DH-007",
    "procedureType": "uitgebreide",
    "deadlineDatum": "2026-12-15",
    "bevoegdGezag": "Gemeente Den Haag",
    "sourceOrganisation": "00000001800866472000"
  },
  {
    "title": "Kappen monumentale linde Boterdiep 12, Groningen",
    "identifier": "2026-OV-0003",
    "caseType": "@omgevingsvergunning",
    "status": "verleend",
    ...
    "deadline": "2026-03-17",
    "vergunningaanvraagRef": "nl.dso.aanvraag.2026-GRN-003",
    "procedureType": "reguliere",
    "deadlineDatum": "2026-03-17",
    "bevoegdGezag": "Gemeente Groningen",
    "sourceOrganisation": "00000001805927466000"
  },
  {
    "title": "Aanbouw woonhuis Mauritsweg 44, Rotterdam",
    "identifier": "2026-OV-0004",
    "caseType": "@omgevingsvergunning",
    "status": "geweigerd",
    ...
    "deadline": "2026-04-07",
    "vergunningaanvraagRef": "nl.dso.aanvraag.2026-RTD-012",
    "procedureType": "reguliere",
    "deadlineDatum": "2026-04-07",
    "bevoegdGezag": "Gemeente Rotterdam",
    "sourceOrganisation": "00000001003214105000"
  }
]
```

### samenwerkverzoek — drie voorbeelden

```json
[
  {
    "initiatorBevoegdGezag": "Gemeente Amsterdam",
    "aangezochtBevoegdGezag": "Waterschap Amstel, Gooi en Vecht",
    "vergunningaanvraagRef": "nl.dso.aanvraag.2026-AMS-001",
    "rationale": "Aanvraag betreft werkzaamheden nabij watergang; watertoets vereist coördinatie met waterschap",
    "status": "aangevraagd",
    "aangevraagdOp": "2026-03-20T10:00:00Z"
  },
  {
    "initiatorBevoegdGezag": "Gemeente Den Haag",
    "aangezochtBevoegdGezag": "Provincie Zuid-Holland",
    "vergunningaanvraagRef": "nl.dso.aanvraag.2026-DH-007",
    "rationale": "Locatie valt deels onder provinciaal inpassingsplan; advies provincie vereist",
    "status": "geaccepteerd",
    "advies": "Provincie heeft geen bezwaar mits de bouwgrens niet wordt overschreden conform het PIP-2023.",
    "aangevraagdOp": "2026-04-05T14:30:00Z",
    "gereageerdOp": "2026-04-18T09:15:00Z"
  },
  {
    "initiatorBevoegdGezag": "Gemeente Groningen",
    "aangezochtBevoegdGezag": "Waterschap Hunze en Aa's",
    "vergunningaanvraagRef": "nl.dso.aanvraag.2026-GRN-015",
    "rationale": "Aanvraag voor dempen sloot vereist watervergunning; samenwerking waterbeheer",
    "status": "afgerond",
    "advies": "Dempen van de sloot is toegestaan conform de keur, mits compenserende waterberging wordt gerealiseerd.",
    "aangevraagdOp": "2026-02-14T11:00:00Z",
    "gereageerdOp": "2026-02-28T16:45:00Z"
  }
]
```
