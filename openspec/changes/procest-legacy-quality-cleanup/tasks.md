...
- [~] DEFERRED: weekly `check:strict` smoke-test cron — the per-PR gate gives — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] DEFERRED: app-config.json note — README + this tasks.md are the record. — deferred to downstream cycle / fleet-wide adoption (handoff)
- [~] DEFERRED: close the burn-down tracking issue — maintainer does this on — deferred to downstream cycle / fleet-wide adoption (handoff)
      merge.
