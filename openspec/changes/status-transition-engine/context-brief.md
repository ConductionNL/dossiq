# Context Brief: Status Transition Engine

**App:** Procest — Case management, VTH, forms
**Spec:** status-transition-engine
**Platform:** Nextcloud + OpenRegister

## Features (1 total, sorted by market demand)

### Workflow and Finite State Machine Management Tools
**demand: 91** (30 tender mentions) | Category: ai
