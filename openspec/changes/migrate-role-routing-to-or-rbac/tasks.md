...
> **Build status (hydra audit 2026-06-10).** No Role*Service or per-app permission tables exist in procest (per the spec's investigation block) — routing is NC-group inference today. Migration is gated on the OR RBAC leaf shipping. Tasks deferred.
