...
- [ ] 1.1 `src/manifest.json` `menu[]`: entry `DataModelLink`, `section:
...
- [ ] 1.2 `#CaseObjects` and the Objects section of `#CaseDetail`: header
  link Manage object types with the same href, `visibleIf` admin.
- [ ] 2.1 `tests/e2e/data-model-link.spec.ts`; `openspec validate
