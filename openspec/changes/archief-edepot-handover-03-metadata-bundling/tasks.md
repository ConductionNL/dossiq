...
- [x] Test: validate both MDTO 1.1 and TMLO 1.2.1 paths — DEFERRED: validateXsd switches on `metadataXsdVersion`; both XSD bundles ship; full e2e parity needs live OR
