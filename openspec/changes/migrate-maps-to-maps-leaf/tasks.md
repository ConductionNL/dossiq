...
> **Build status (hydra audit 2026-06-10).** Spec is leaf-adoption-only; gated on the OR maps leaf shipping. Current GIS stack (GisProxyService, WmsWfsService, PdokLocatieserverService, LocationService, MapLayerService) ships natively. Tasks deferred until the leaf landing.
