...
- [x] **T1**: Add `OCA\Procest\Portal\PortalContributionProvider` — a
  ...
  portal sees procest's tenders/contracts/invoices scoped to their `supplierRef`.

- [ ] **T2**: Retire procest's in-app supplier views (`src/views/leverancier/*`,
