# Context Brief: Signalering Widgets Specification

**App:** Procest — Case management, VTH, forms
**Spec:** signalering-widgets
**Platform:** Nextcloud + OpenRegister

## Features (1 total, sorted by market demand)

### Retention deadline alerts and review workflows
**demand: 84** (28 tender mentions) | Category: scheduling
