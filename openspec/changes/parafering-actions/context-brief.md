...
### Initiate a multi-party document signing workflow
**demand: 6290** (2096 tender mentions) | Category: document-management
...
### Digital Signature with Signature Profiles Support
**demand: 485** (161 tender mentions) | Category: governance

### Electronic Signature and Workflow Management
**demand: 357** (117 tender mentions) | Category: other

### E-signature workflow
**demand: 258** (74 tender mentions) | Category: other

### 5.8 Initiatives digital signature process change
**demand: 218** (72 tender mentions) | Category: other

### If you use the Initiatives module, we have some improvements in the Signature workflow. Read more about it at:
**demand: 93** (30 tender mentions) | Category: other

### Digital Signing Process Records
**demand: 67** (22 tender mentions) | Category: other

### Complex E-Signature Workflow Management
