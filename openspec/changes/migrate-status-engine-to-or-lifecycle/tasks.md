...
- [~] P-1.2 Create `lib/Lifecycle/VoorstelSubmitGuard.php` with a single method — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] P-3.2 Create `lib/Lifecycle/HoorzittingAfzienGuard.php` with a single method — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] P-3.3 Create `lib/Lifecycle/BezwaarDeadlineGuard.php` with a single method — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] P-4.1 Remove the four `const STATUS_*` declarations from — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] P-4.2 Update all callers of `ParaferingService::STATUS_*` constants across the codebase — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] P-4.3 Remove or refactor direct `saveObject` calls in `ParaferingService` that set — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] P-5.1 Remove Application.php event listener registrations for any — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] P-5.2 Add `x-openregister-hooks` entries to the affected schemas in — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] P-6.1 Create `tests/Unit/Lifecycle/VoorstelLifecycleTest.php` covering: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] P-6.2 Create `tests/Unit/Lifecycle/BezwaarLifecycleTest.php` covering: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] P-6.3 Create `tests/Unit/Lifecycle/ParaferingServiceStepTest.php` confirming — deferred to downstream cycle / fleet-wide adoption (handoff)
