...
configuration MUST declare the following per the AWB:
...
a checklist enforcing the following AWB criteria:
...
compiling this dossier for sharing with Juridische Zaken or court.
