...
- [ ] 1.1 `lib/Service/AssigneeResolver.php`: steps three and four (case
...
- [ ] 1.2 `lib/Service/Transitions/CreateTaskHandler.php` header: document
  the order and the reserved word.
- [ ] 1.3 Fixture pair: `DossiqAskPersonNode` and `CreateTaskHandler` land
