# Context Brief: Procest Case Management

**App:** Procest — Case management, VTH, forms
**Spec:** procest-case-management
**Platform:** Nextcloud + OpenRegister

## Features (635 total, sorted by market demand)

### Contract document processing and key term extraction
**demand: 6246** (2075 tender mentions) | Category: document-management

### No-code DocHorizon intelligent document processing platform
**demand: 6234** (2071 tender mentions) | Category: document-management

### & integrations: features include a high accuracy rate in document processing
**demand: 6219** (2072 tender mentions) | Category: document-management

### (container) separate document intelligence none file formats pdf only pdf
**demand: 6215** (2071 tender mentions) | Category: document-management

### Document management with version control and workflow
**demand: 2548** (845 tender mentions) | Category: document-management

### PO revision management with change tracking and re-approval workflow
**demand: 2468** (820 tender mentions) | Category: analytics

### PO amendment management with version history and re-approval workflow
**demand: 2450** (814 tender mentions) | Category: core

### Supplier portal with self-service profile management and document submission
**demand: 2419** (800 tender mentions) | Category: document-management

### 100% digital solicitation process with electronic bid submission and receipt
**demand: 2108** (702 tender mentions) | Category: other

### Contract renewal management with proactive notification and renegotiation workflow
**demand: 1889** (627 tender mentions) | Category: scheduling

### Contract renewal and extension workflow with compliant procedure management
**demand: 1869** (621 tender mentions) | Category: other

### PO change management with supplier notification and acknowledgment workflow
**demand: 1840** (612 tender mentions) | Category: scheduling

### Contract authoring with template library, clause management, and approval workflow
**demand: 1832** (604 tender mentions) | Category: document-management

### Vendor bill management with approval workflow before payment
**demand: 1789** (589 tender mentions) | Category: other

### Tax Workflow Management
**demand: 1775** (583 tender mentions) | Category: other

### Catalog content management with automated validation and update workflow
**demand: 1760** (584 tender mentions) | Category: ai

### Bills and purchase order management with approval workflows
**demand: 1679** (548 tender mentions) | Category: other

### Catalog content management with automated validation and enrichment workflows
**demand: 1603** (531 tender mentions) | Category: ai

### Expense management with receipt capture and reimbursement processing
**demand: 1598** (530 tender mentions) | Category: other

### Supplier payment management with global payment processing in 196 countries
**demand: 1598** (532 tender mentions) | Category: other

### Payroll management with wage, salary, and deduction processing
**demand: 1592** (530 tender mentions) | Category: other

### Supplier collaboration portal for centralized communication, RFx responses, and PO management
**demand: 1592** (530 tender mentions) | Category: collaboration

### Transparent and Competitive Procurement Process Design
**demand: 1453** (484 tender mentions) | Category: other

### User management ProcessMaker
**demand: 1409** (467 tender mentions) | Category: other

### Route requisition through approval workflow
**demand: 1179** (393 tender mentions) | Category: other

### E-tendering with secure bid submission and sealed bid opening workflow
**demand: 1127** (375 tender mentions) | Category: other

### Vendor onboarding workflow with document collection and approval
**demand: 1095** (359 tender mentions) | Category: document-management

### Supplier onboarding workflow with automated document verification
**demand: 1074** (354 tender mentions) | Category: document-management

### digital workflow
**demand: 1068** (325 tender mentions) | Category: other
...
**demand: 996** (244 tender mentions) | Category: other

### Workflow for Document Review
**demand: 926** (308 tender mentions) | Category: document-management

### Real-time document processing with automatic field extraction
**demand: 901** (299 tender mentions) | Category: document-management

### Intelligent Document Processing (IDP) beyond basic OCR
**demand: 886** (294 tender mentions) | Category: document-management

### Email Processing
**demand: 854** (283 tender mentions) | Category: other

### Service confirmation workflow with milestone-based delivery acceptance
**demand: 833** (277 tender mentions) | Category: other

### Citizen Communication and Email Management
**demand: 800** (266 tender mentions) | Category: participation

### JAI Autopilot: autonomous end-to-end procurement workflow orchestration (2026)
**demand: 758** (252 tender mentions) | Category: other

### Comprehensive Procurement Process Management Suite
**demand: 739** (246 tender mentions) | Category: other

### Process budget amendment
**demand: 708** (236 tender mentions) | Category: core

### Digital Invoice Processing
**demand: 679** (214 tender mentions) | Category: other

### Expense claim submission with receipt upload and approval workflow
**demand: 679** (221 tender mentions) | Category: other

### Service entry sheet processing for confirming delivery of service-based POs
**demand: 635** (211 tender mentions) | Category: other

### Approval workflow with budget impact review at each decision point
**demand: 604** (200 tender mentions) | Category: core

### Search within Handle Workflow Exception
**demand: 597** (199 tender mentions) | Category: other
...
### Search objects by attachment document type or filename
**demand: 531** (177 tender mentions) | Category: document-management
...
**demand: 514** (141 tender mentions) | Category: other

### Custom multi-level approval workflows set up per organizational delegation policy
**demand: 514** (168 tender mentions) | Category: governance

### Workflow Power Automate SP
**demand: 508** (139 tender mentions) | Category: other

### Detect and flag workflow exception
**demand: 506** (139 tender mentions) | Category: other

### Resolve exception and continue workflow
**demand: 506** (139 tender mentions) | Category: other

### Configure Nextcloud Files as document storage
**demand: 502** (166 tender mentions) | Category: document-management

### Purchase Approval Workflow
**demand: 481** (157 tender mentions) | Category: other

### Added an option to query for parent and root scope ids for (historic) case, process and task instances.
**demand: 461** (153 tender mentions) | Category: other

### Support for updating more task properties when doing case and process instance migration
**demand: 461** (153 tender mentions) | Category: other

### View Handle Workflow Exception overview
**demand: 459** (153 tender mentions) | Category: other
...
**demand: 455** (151 tender mentions) | Category: security

### Receive notifications for Handle Workflow Exception
**demand: 425** (139 tender mentions) | Category: other

### Workflow-as-Code (Go/Java/TS/Python)
**demand: 423** (139 tender mentions) | Category: other

### Export Handle Workflow Exception data
**demand: 423** (141 tender mentions) | Category: document-management

### Workflow Exception Activity Internal Notes
**demand: 420** (140 tender mentions) | Category: other

### Decision-Making Process and Case Modeling
**demand: 419** (129 tender mentions) | Category: core

### Process Engagement from Ideation to Decision-Making
...
### Citizen Portal
**demand: 391** (127 tender mentions) | Category: participation

### Notification Workflow
**demand: 382** (46 tender mentions) | Category: scheduling

### Automated Sales Order Processing and Payment Validation
**demand: 353** (117 tender mentions) | Category: other

### Invoice email custom templates per workflow
**demand: 348** (114 tender mentions) | Category: other

### Quantity discrepancy tracking with automated alerts and resolution workflow
**demand: 341** (113 tender mentions) | Category: core

### Invoice email auto-send via workflow
**demand: 340** (112 tender mentions) | Category: other

### Run dunning workflow
**demand: 333** (111 tender mentions) | Category: other

### Board Meeting Workflows
**demand: 333** (110 tender mentions) | Category: core

### Document Workflow
**demand: 331** (59 tender mentions) | Category: document-management

### Reconciliation workflow with matched/unmatched transaction review
**demand: 331** (109 tender mentions) | Category: other

### Invoice approval workflow with matching exceptions and dispute resolution
**demand: 317** (99 tender mentions) | Category: core

### Search within Project Participation Process
**demand: 309** (103 tender mentions) | Category: participation

### Search within Processing Register Update
**demand: 297** (99 tender mentions) | Category: other

### Land Management Process Streamlining
...
### Video Workflow GUI for Analysts
**demand: 289** (96 tender mentions) | Category: media

### Association Management with Payment Processing
**demand: 289** (96 tender mentions) | Category: other

### Communication and Creativity Support for Governance Processes
**demand: 284** (94 tender mentions) | Category: governance

### Bank reconciliation workflow with unmatched item resolution
**demand: 281** (93 tender mentions) | Category: core

### Automated Invoice Creation and Sales Process Workflow
**demand: 278** (92 tender mentions) | Category: other

### UTC Date Property Formatting in API Responses
**demand: 278** (92 tender mentions) | Category: other

### VTH processen
**demand: 275** (90 tender mentions) | Category: other

### Documenten
**demand: 272** (38 tender mentions) | Category: other

### Shared Workflow Environments with Agency-Specific Access Controls
**demand: 271** (90 tender mentions) | Category: security

### Community Participation Process Initiation
**demand: 271** (74 tender mentions) | Category: participation

### Added support to execute a decision service in the DMN REST API.
**demand: 270** (85 tender mentions) | Category: core

### Process subsidy award advance payment
**demand: 270** (90 tender mentions) | Category: other

### Agenda Builder and Board Pack Publishing Workflow
**demand: 263** (85 tender mentions) | Category: core

### Budget override workflow for exceptional purchases requiring additional authorization
**demand: 260** (86 tender mentions) | Category: other

### Citizen Reporting Portal
**demand: 256** (47 tender mentions) | Category: participation

### Mass payment processing with batch scheduling and payment approval workflow
**demand: 254** (76 tender mentions) | Category: other

### Purchase order creation with receiving workflow and bill matching
**demand: 250** (82 tender mentions) | Category: other

### Citizen Portal Integration
**demand: 245** (71 tender mentions) | Category: participation

### Meeting Workflow
**demand: 239** (39 tender mentions) | Category: core

### Semantic Models for Business Document Processing
**demand: 238** (79 tender mentions) | Category: other

### Code List Import with Security Sanitization
**demand: 233** (77 tender mentions) | Category: document-management

### Evaluation consensus workflow for committee-based award decisions
**demand: 233** (77 tender mentions) | Category: other

### Self-service supplier registration with frictionless onboarding workflow
**demand: 233** (77 tender mentions) | Category: other

### Quote creation with conversion to invoice workflow
**demand: 231** (73 tender mentions) | Category: other

### Process supplier credit note against original invoice
**demand: 230** (76 tender mentions) | Category: other

### Mini-competition within framework agreements with simplified bidding workflow
**demand: 224** (74 tender mentions) | Category: other

### Invoice matching against purchase orders and receipts with exception workflow
**demand: 223** (71 tender mentions) | Category: other

### Contract authoring with clause library, redlining, and collaborative negotiation workflow
**demand: 222** (72 tender mentions) | Category: other

### Automate reminder escalation workflow
**demand: 221** (71 tender mentions) | Category: scheduling

### Bank reconciliation workflow with automatic and manual matching
**demand: 221** (69 tender mentions) | Category: other

### Custom workflow engine for automating business processes
**demand: 221** (71 tender mentions) | Category: other

### Touchless invoice processing with automatic matching and exception-based workflow
**demand: 218** (70 tender mentions) | Category: other

### Supplier onboarding workflow with configurable qualification questionnaires and approvals
**demand: 218** (70 tender mentions) | Category: other

### Industry-Specific Workflow Customization
**demand: 216** (70 tender mentions) | Category: other

### Bank reconciliation with statement balance verification workflow
**demand: 215** (69 tender mentions) | Category: other

### Invoice matching with PO and receipt validation and exception workflow
**demand: 213** (69 tender mentions) | Category: other

### Invoice status workflow (draft, sent, viewed, partial, paid, overdue, cancelled)
**demand: 211** (69 tender mentions) | Category: other

### Exception-based workflow routing queries and discrepancies to appropriate handlers
**demand: 209** (69 tender mentions) | Category: other

### Secure Contract Signing Within Workflow
**demand: 208** (69 tender mentions) | Category: other

### Initiate the annual accounts sign-off workflow
**demand: 207** (69 tender mentions) | Category: other

### Search within BAG Mutation Processing
**demand: 195** (65 tender mentions) | Category: other

### Publish a validated process model to production
**demand: 192** (64 tender mentions) | Category: other

### Minutes approval workflow
**demand: 186** | Category: minutes and decisions
Chair/secretary review and approval of draft minutes

### Complete no-code configuration toolkit for process customization without IT involvement
**demand: 185** (61 tender mentions) | Category: other

### Department-Level Access Permission Management
**demand: 185** (61 tender mentions) | Category: security

### Process consent agenda items (hamerstukken)
**demand: 184** (32 tender mentions) | Category: core

### Multi-level expense approval workflow automation
**demand: 184** (60 tender mentions) | Category: other

### Amendement Workflow
**demand: 179** (42 tender mentions) | Category: other

### Enhanced Access Control and Process Transparency
**demand: 177** (58 tender mentions) | Category: security

### Workflow authorized users and groups
**demand: 174** (32 tender mentions) | Category: other

### Board Sign Off Workflow
**demand: 174** (57 tender mentions) | Category: other

### Motion Workflow
**demand: 174** (40 tender mentions) | Category: core

### Enhancement Request: Improve pipeline search behavior in Workflow condition dropdown
**demand: 173** (57 tender mentions) | Category: other

### Taken (Tasks)
**demand: 172** (32 tender mentions) | Category: other

### Workflow approve/decline with comments
**demand: 171** (31 tender mentions) | Category: other

### View Project Participation Process overview
**demand: 171** (57 tender mentions) | Category: participation

### Low-code platform customization adapting procurement processes to organizational needs
**demand: 170** (56 tender mentions) | Category: other

### Procure-to-pay automation workflow
**demand: 168** (54 tender mentions) | Category: other

### Mobile Workflow and Approval Access Across iOS and Android
**demand: 166** (55 tender mentions) | Category: security

### End-to-End Revenue Lifecycle Workflow
**demand: 165** (54 tender mentions) | Category: other

### Workflow Engine for Task Automation
**demand: 165** (54 tender mentions) | Category: other

### Monitor progress of a multi-party signing workflow
**demand: 165** (55 tender mentions) | Category: other

### Standardized Workflow Creation for Contract Approval and Review
**demand: 162** (53 tender mentions) | Category: other

### View Processing Register Update overview
**demand: 159** (53 tender mentions) | Category: other

### Export Project Participation Process data
**demand: 159** (53 tender mentions) | Category: document-management

### DPO review of data processing agreement
**demand: 156** (52 tender mentions) | Category: other

### Workflow email and popup alerts
**demand: 153** (44 tender mentions) | Category: other

### Board Operations and Workflow Streamlining Tools
**demand: 152** (49 tender mentions) | Category: other

### Configure the statutory deadline parameters in the process
...
**demand: 139** (43 tender mentions) | Category: scheduling

### [Workflow: Approval]
**demand: 136** (42 tender mentions) | Category: other

### Agm Planning Workflows
**demand: 132** (25 tender mentions) | Category: scheduling

### Rules: New workflow (flows) system.
**demand: 131** (43 tender mentions) | Category: other

### Task Mining and Process Orchestration
**demand: 130** (43 tender mentions) | Category: other

### Workflow Delay Configuration
**demand: 129** (41 tender mentions) | Category: other

### Forward receipts to a dedicated email address for automatic processing
**demand: 129** (43 tender mentions) | Category: other

### Citizen Portal (Persoonlijke Internet Pagina / PIP)
**demand: 128** (32 tender mentions) | Category: participation

### Idle Shutdown with Configurable Timeout
**demand: 128** (42 tender mentions) | Category: other

### Schedule & Cron Workflows
**demand: 128** (36 tender mentions) | Category: scheduling

### Customizable buying and approval workflows enforcing compliance policies
**demand: 126** (38 tender mentions) | Category: governance

### Workflow auto-attachment to folders
**demand: 125** (41 tender mentions) | Category: document-management

### Compliance-enforcing workflows ensuring buyers purchase within corporate policies
**demand: 122** (40 tender mentions) | Category: governance

### Create nurture workflow
**demand: 120** (40 tender mentions) | Category: other

### Export Processing Register Update data
**demand: 120** (40 tender mentions) | Category: document-management

### Process credit note
**demand: 116** (38 tender mentions) | Category: other

### Receive notifications for Project Participation Process
**demand: 114** (38 tender mentions) | Category: participation

### Interne Taken (Internal Tasks) -- Open Klant
**demand: 112** (36 tender mentions) | Category: other

### Permission and Workflow Engines
**demand: 112** (36 tender mentions) | Category: security

### Membership and Event Workflow Support
**demand: 110** (29 tender mentions) | Category: other

### workflow execution within any
**demand: 110** (29 tender mentions) | Category: other

### Workflow Engine
**demand: 109** (33 tender mentions) | Category: other

### AI-Powered Agenda and Summary Workflows
**demand: 108** (35 tender mentions) | Category: ai

### Workflow Orchestration through Queries
**demand: 108** (33 tender mentions) | Category: other

### Respond to information request via citizen portal
**demand: 107** (25 tender mentions) | Category: participation

### Receive notifications for Processing Register Update
**demand: 105** (35 tender mentions) | Category: other

### Call and Real-Time Chat Management
**demand: 104** (34 tender mentions) | Category: collaboration

### Search CRM Process Audit
**demand: 104** (34 tender mentions) | Category: governance

### Approval workflow engine
**demand: 103** (31 tender mentions) | Category: other

### Advanced Workflow Actions: Enhanced HTTP actions with proper encoding, JSON parsing, and error handling
**demand: 101** (33 tender mentions) | Category: other

### Link to stop running workflow in Workflow runs list
**demand: 101** (33 tender mentions) | Category: other

### Business status events - Dispatch events when updating the business status of a case or process
**demand: 98** (32 tender mentions) | Category: other

### PDF/A and PDF/UA Compliance Validation
**demand: 98** (32 tender mentions) | Category: governance

### Automated Invoice Data Extraction and Processing
**demand: 97** (32 tender mentions) | Category: other

### Workflow Nets
**demand: 96** (32 tender mentions) | Category: other

### Direct Delivery Tracking from Odoo
**demand: 95** (31 tender mentions) | Category: other

### like budget approval workflows
**demand: 95** (28 tender mentions) | Category: other

### Payroll processing with automatic tax calculation and compliance
**demand: 93** (29 tender mentions) | Category: governance

### Multi-step destruction authorization workflow
**demand: 91** (29 tender mentions) | Category: other

### Export CRM Process Audit Data
**demand: 90** (30 tender mentions) | Category: governance

### Record sub-processor details on a DPA
**demand: 90** (30 tender mentions) | Category: other

### Approval Workflows
**demand: 87** (27 tender mentions) | Category: other

### Resume saved draft from citizen portal
**demand: 86** (18 tender mentions) | Category: participation

### this process through:
**demand: 84** | Category: other

### Access Data from Previous Workflow Nodes
**demand: 82** (27 tender mentions) | Category: security

### Search DPIA for CRM Processing
**demand: 78** (24 tender mentions) | Category: other

### Search Sales Process Optimization
**demand: 78** (24 tender mentions) | Category: other

### PDF/A and PDF/UA API Improvements with OCG Layer Identification
**demand: 77** (25 tender mentions) | Category: document-management

### workflow engine
**demand: 72** (23 tender mentions) | Category: other

### Asset Depreciation Handling for Internal Transfer Invoices
**demand: 71** (23 tender mentions) | Category: other

### Pre-built Connectors and Workflow Orchestration
**demand: 70** (23 tender mentions) | Category: other

### Purchase order processing
**demand: 62** (16 tender mentions) | Category: other

### Parallel and sequential approval workflows with delegation and escalation rules
**demand: 62** (9 tender mentions) | Category: other

### Pre-configured approval workflows for requisitions, invoices, and contracts
**demand: 61** (12 tender mentions) | Category: other

### peer review process
**demand: 61** (15 tender mentions) | Category: other

### Export DPIA for CRM Processing Data
**demand: 60** (20 tender mentions) | Category: document-management

### AI-Assisted Approval Workflows
**demand: 57** (9 tender mentions) | Category: ai

### Block invoice processing when budget ceiling is exceeded
...
### Process Services
**demand: 56** (18 tender mentions) | Category: other

### View BAG Mutation Processing overview
...
### Exception-based approval workflows auto-approving compliant purchases
**demand: 52** (9 tender mentions) | Category: other

### Process payment batches with multi-level approval
**demand: 52** (14 tender mentions) | Category: other

### View CRM Process Audit Overview
**demand: 51** (17 tender mentions) | Category: governance

### Advanced PO approval workflows with automated routing and bottleneck elimination
**demand: 49** (11 tender mentions) | Category: ai

### citizen self-service portals
**demand: 49** (16 tender mentions) | Category: participation

### Invoice processing
**demand: 49** (15 tender mentions) | Category: other

### Change Notes for Process Version Activation
**demand: 48** (16 tender mentions) | Category: document-management

### Contract Creation with Legal Controls and Automated Approval
**demand: 47** (14 tender mentions) | Category: ai

### PDF/A and PDF/UA Compliance with Operation Ordering
**demand: 47** (15 tender mentions) | Category: governance

### Self-Approval Prevention for Workflow Change Requests
**demand: 41** (13 tender mentions) | Category: governance

### Automated approval routing reducing cycle times with parallel and sequential workflows
**demand: 41** (9 tender mentions) | Category: ai

### Event-Based Workflow Field Filtering and Change Validation
**demand: 41** (13 tender mentions) | Category: governance

### Association Payment Recording and Processing
**demand: 40** (13 tender mentions) | Category: other

### Citizen Portal
**demand: 40** (10 tender mentions) | Category: participation

### Receive CRM Process Audit Notifications
**demand: 39** (13 tender mentions) | Category: governance

### AI-powered invoice processing with automated data extraction and matching
**demand: 37** (7 tender mentions) | Category: ai

### Optionally migrate in-flight cases to the new process version
**demand: 36** (12 tender mentions) | Category: document-management

### Roll back the active process to a previous version
**demand: 36** (12 tender mentions) | Category: document-management

### Supplier discovery tools with qualification assessment and shortlisting workflows
**demand: 35** (11 tender mentions) | Category: other

### Customer-specific order processing with personalized workflows per buying organization
**demand: 35** (11 tender mentions) | Category: other

### Threshold-based approval workflows auto-routing POs to correct managers by amount
**demand: 33** (9 tender mentions) | Category: other

### Purchase invoice processing with OCR scanning and three-way matching
**demand: 33** (9 tender mentions) | Category: other

### Tasklist Filters: allow to filter for specific version or all versions of a process version
**demand: 32** (10 tender mentions) | Category: document-management

### Improved history cleaning to limit the amount of sub process instances in one bulk delete.
**demand: 32** (10 tender mentions) | Category: other

### Invoice matching with approval and batching for payment processing
**demand: 32** (10 tender mentions) | Category: other

### Support for including only defined variables when querying (Historic) Process / Case instances
**demand: 32** (10 tender mentions) | Category: other

### GitHub Actions CI with Multi-Platform Docker Support
**demand: 32** (10 tender mentions) | Category: other

### Centralized Meeting Information and Workflow Management
**demand: 31** (10 tender mentions) | Category: core

### Purchase invoice processing with OCR scanning and auto-entry
**demand: 31** (7 tender mentions) | Category: other

### Filter CRM Process Audit Items
**demand: 30** (10 tender mentions) | Category: governance

### Export BAG Mutation Processing data
**demand: 29** (9 tender mentions) | Category: document-management

### Added support for enabling event sub process start events in the process instance migration logic.
**demand: 29** (9 tender mentions) | Category: other
...
### Multi-Type Document Processing Support
**demand: 28** (9 tender mentions) | Category: other

### Maintain processing register
**demand: 27** (9 tender mentions) | Category: other

### Bank statement import via MT940/CSV with automatic processing
**demand: 26** (4 tender mentions) | Category: document-management

### Real-time Process Monitoring
**demand: 26** (4 tender mentions) | Category: other

### Added support for direct migration of async service tasks inh the process migration.
**demand: 26** (8 tender mentions) | Category: other

### Track invoice processing status in real time
**demand: 25** (5 tender mentions) | Category: other

### Export Sales Process Optimization Data
**demand: 24** (8 tender mentions) | Category: document-management

### Multiple Approval Levels in Processes
**demand: 23** (5 tender mentions) | Category: other

### Invoice processing with automated data capture and validation
**demand: 23** (6 tender mentions) | Category: ai

### EventBrokerProcessor HTTP Request to Account Portal
**demand: 23** (7 tender mentions) | Category: other

### Custom Workflow Creation Without Coding
**demand: 22** (7 tender mentions) | Category: other

### AI-powered Process Mining
**demand: 21** (1 tender mentions) | Category: ai

### View DPIA for CRM Processing Overview
**demand: 21** (7 tender mentions) | Category: other

### View Sales Process Optimization Overview
**demand: 21** (7 tender mentions) | Category: other

### Workflow Management: Resolved Flowable suspension state conflict after migration.
**demand: 20** (6 tender mentions) | Category: other

### DEVSIX-9626 – Create an implementation for non-EU trusted lists processing
**demand: 20** (6 tender mentions) | Category: other

### Goods receipt reversal and return processing with quantity and value adjustments
**demand: 20** (6 tender mentions) | Category: other

### In-memory real-time processing
**demand: 19** (5 tender mentions) | Category: other

### Automatic Invoice Processing for ERP Systems
**demand: 19** (6 tender mentions) | Category: other

### ML receipt/invoice OCR with 99.9% accuracy processing 320M documents/year
**demand: 19** (5 tender mentions) | Category: other

### Process Instance Migration
**demand: 19** (5 tender mentions) | Category: other

### Approval Workflows with Unified Status Visibility
**demand: 19** (6 tender mentions) | Category: other

### Approval Workflows in Checklists
**demand: 19** (5 tender mentions) | Category: other

### Batch payment processing for high-volume operations
**demand: 18** (4 tender mentions) | Category: other

### Citizen Submission Portal
**demand: 18** | Category: participation
Online case submission with document upload, draft save, and confirmation

### Process year-end accruals and provisions
**demand: 18** (6 tender mentions) | Category: other

### UBL auto-import and processing of electronic invoices
**demand: 17** (5 tender mentions) | Category: document-management
...
### Header Support in Event Models for Case and Process Definitions
**demand: 17** (5 tender mentions) | Category: other

### Currency revaluation processing at period end
**demand: 17** (3 tender mentions) | Category: other
...
**demand: 16** (5 tender mentions) | Category: other

### Data Processing and Control Algorithm Simulation
**demand: 16** (5 tender mentions) | Category: other
...
**demand: 16** (2 tender mentions) | Category: other

### MIME Type Restrictions for File Upload
**demand: 14** (4 tender mentions) | Category: document-management

### Custom Workflows
**demand: 14** | Category: other

### Dynamic Event Subscription Creation for Process Instances
**demand: 14** (4 tender mentions) | Category: other

### Advance payment processing with application against future invoices
**demand: 14** (4 tender mentions) | Category: other

### Event Registry Start Event Support for Unique Process Instances
**demand: 14** (4 tender mentions) | Category: other

### Trustly direct bank payment processing
**demand: 13** (3 tender mentions) | Category: other

### Payment Processing
**demand: 13** (1 tender mentions) | Category: other

### Invoice payment processing with partial payment support
**demand: 13** | Category: other
...
### ACH bank transfer payment processing
**demand: 12** | Category: other
...
**demand: 11** (3 tender mentions) | Category: document-management
...
### AP automation with invoice capture, matching, and payment processing
**demand: 11** (1 tender mentions) | Category: other
...
**demand: 10** (3 tender mentions) | Category: other

### Batch Filing Processing
**demand: 10** | Category: other

### VTH process support
**demand: 10** | Category: other

### Process Planning Context Visualization at Design Stage
**demand: 10** (3 tender mentions) | Category: other

### Third-Party Service Integration and Custom Workflow Building
**demand: 10** (3 tender mentions) | Category: other

### High-Performance Data Processing and Message Delivery
**demand: 10** (3 tender mentions) | Category: other

### process analysis
**demand: 10** (3 tender mentions) | Category: other

### Structured Taxonomy Development Process
**demand: 10** (3 tender mentions) | Category: other

### workflow-cache
**demand: 9** | Category: general
Discovered from GitHub issue in twentyhq/twenty
...
### Receive Sales Process Optimization Notifications
**demand: 9** (3 tender mentions) | Category: other

### Payment processing
**demand: 9** (1 tender mentions) | Category: other

### Automatic Work Entry Processing
**demand: 9** (2 tender mentions) | Category: other

### Credit card processing (Visa/Mastercard/Amex/Maestro)
**demand: 9** (1 tender mentions) | Category: other

### Payroll processing with automatic tax calculation (select regions)
**demand: 9** (1 tender mentions) | Category: other
...
### Kubernetes Orchestrator for Metadata Agents
**demand: 8** (2 tender mentions) | Category: other
...
Discovered from GitHub issue in backstage/backstage

### Process AI
**demand: 7** (1 tender mentions) | Category: ai

### Social and Health Data Processing via Cloud
...
### Global payments in 120+ currencies with cross-border payment processing
**demand: 7** (1 tender mentions) | Category: other

### AP automation with automated payment processing and reconciliation
**demand: 7** (1 tender mentions) | Category: ai

### Template and Workflow Customization for Business Needs
**demand: 7** (2 tender mentions) | Category: other
...
### Municipality Selection Process
**demand: 7** (2 tender mentions) | Category: other

### PDF Workflows
**demand: 7** | Category: document-management

### Hyper-automation for invoice capture, matching, and approvals with AI processing
**demand: 7** (1 tender mentions) | Category: ai

### Value-Based Contract Approval Workflows
**demand: 7** (2 tender mentions) | Category: other

### Automated Processing and Error Reduction
**demand: 7** (2 tender mentions) | Category: ai

### Process Model Schematic Visualization
**demand: 7** (2 tender mentions) | Category: other

### Department-Specific Custom Workflow Creation
**demand: 7** (2 tender mentions) | Category: other

### Mobile and Web App Workflow Support
**demand: 7** (2 tender mentions) | Category: other

### Alipay and Alipay+ cross-border payment processing
**demand: 7** (1 tender mentions) | Category: other

### Delphi Process Surveys and Streamlining Tools
**demand: 7** (2 tender mentions) | Category: other

### Participative Process Management for Elections
**demand: 7** (2 tender mentions) | Category: other

### Process Improvement Insights for Researchers
**demand: 7** (2 tender mentions) | Category: other

### Real-Time Urban Process Analytics
**demand: 7** (2 tender mentions) | Category: other
...
### Archiving Workflow
**demand: 6** | Category: document-management
Trigger archiving on case closure with retention policy enforcement

### Process grant application
**demand: 6** (2 tender mentions) | Category: other

### Batch operations for processing multiple transactions
**demand: 6** | Category: other

### Bancontact (Belgium) payment processing
**demand: 6** | Category: other

### Giropay (Germany) payment processing
**demand: 6** | Category: other

### EPS (Austria) payment processing
**demand: 6** | Category: other

### KBC/CBC (Belgium) payment processing
**demand: 6** | Category: other

### Voucher and meal voucher payment processing
**demand: 6** | Category: other

### Payroll processing with automatic tax calculation and filing (via Gusto)
**demand: 6** | Category: other

### Przelewy24 (Poland) payment processing
**demand: 6** | Category: other
...
### Manage share issuance process
**demand: 6** (2 tender mentions) | Category: other

### Migration Process Analytics
**demand: 6** | Category: other

### Reset a test case and rerun the process from the start
**demand: 6** (2 tender mentions) | Category: other

### Compare two process versions side by side
**demand: 6** (2 tender mentions) | Category: other

### Scan a batch of documents to processing queue
**demand: 6** | Category: other
...
### various workflows and
**demand: 5** | Category: other

### PayTrace credit card processing with token billing
...
### API Endpoints for Collections, Search, Exporters, Version Comparison, and Data Auditing
**demand: 5** (1 tender mentions) | Category: document-management
...
### Refund processing for direct debit payments
**demand: 5** (1 tender mentions) | Category: other

### Process mapping Nintex
**demand: 5** (1 tender mentions) | Category: other

### Bank statement processing and verification
**demand: 5** (1 tender mentions) | Category: other

### Process-driven CRM
**demand: 5** (1 tender mentions) | Category: other

### ingest-validate-processor
**demand: 5** | Category: general
Discovered from GitHub issue in elastic/elasticsearch

### Automated employee expense reimbursement processing
**demand: 5** (1 tender mentions) | Category: ai
...
### Aged receivables/payables with automated dunning process
**demand: 5** (1 tender mentions) | Category: ai

### Sub-process Support
**demand: 5** (1 tender mentions) | Category: other

### Bulk Case and Process Instance Management Operations
**demand: 5** (1 tender mentions) | Category: other
...
### No-Code and Code Workflow Support
**demand: 4** | Category: other

### Data Protection and Legal Process Integrity
**demand: 4** (1 tender mentions) | Category: other

### Customizable and Scalable Contract Processes
**demand: 4** (1 tender mentions) | Category: other
...
**demand: 4** | Category: ai

### subprocess-message-hook
**demand: 4** | Category: general
Discovered from GitHub issue in PrefectHQ/prefect
...
### Built-In Exception Handling Workflows
**demand: 4** (1 tender mentions) | Category: other
...
### workflow-template-id-load
**demand: 4** | Category: general
Discovered from GitHub issue in projectdiscovery/nuclei

### Marketplace split payment processing
**demand: 4** | Category: other
...
**demand: 3** | Category: ai

### workflow-log-writer
**demand: 3** | Category: general
...
### Enforce a periodic access review workflow
**demand: 3** (1 tender mentions) | Category: security

### Process modeling Activiti
**demand: 3** | Category: other

### Form Routing for Departmental Processing
**demand: 3** | Category: other
...
### date-processing
**demand: 3** | Category: general
Discovered from GitHub issue in Budibase/budibase

### Model error-catching event subprocess
**demand: 3** (1 tender mentions) | Category: other

### Configure DSO-compatible workflows
**demand: 3** (1 tender mentions) | Category: other
...
### Process simulation Celonis
**demand: 2** | Category: other

### Optimized Solr Indexing with Reduce-Deletes Flag
**demand: 2** | Category: other

### iDocumenten DMS
**demand: 2** | Category: other

### Documenten & Elektronische Handtekeningen
**demand: 2** | Category: Document Management
Digitaal ondertekenen en opslaan van documenten, 80% minder administratie

### Workflow Management
**demand: 2** | Category: Care Management
Continue zichtbaarheid van status per cliënt in het zorgproces
...
### POS terminal payment processing (in-store)
**demand: 2** | Category: other

### workflows-tech-preview
...
**demand: 2** | Category: ai

### negative-workflow-condition
**demand: 2** | Category: general
Discovered from GitHub issue in projectdiscovery/nuclei

### PO Flip enabling suppliers to convert POs into invoices for streamlined processing
**demand: 2** | Category: other

### AI OCR: invoice/receipt processing in 0.5-4 seconds with fraud detection
**demand: 2** | Category: ai

### Autonomous invoice processing: 99% accuracy, 85% no-touch rate (trained on 1B invoices)
**demand: 2** | Category: other

### AI Agent 99% Auto-Expense Processing
**demand: 2** | Category: ai
...
### Card-type Specific Workflows
**demand: 2** | Category: other

### Notary and witness workflows
**demand: 2** | Category: other
...
### Preparation Workflow Streamlining
**demand: 2** | Category: other

### GDPR-Compliant Local Audio Processing
**demand: 2** | Category: media

### Payroll Processing
**demand: 2** | Category: Payroll
Automated payroll with federal, state and local tax filing for US employees

### union-specific workflows
**demand: 2** | Category: other

### workflow-target-matchers
**demand: 2** | Category: general
Discovered from GitHub issue in projectdiscovery/nuclei
...
### Payroll Workflow
**demand: 2** | Category: Payroll
Structured payroll processing workflow with built-in checks and controls

### cloud processing
**demand: 2** | Category: other

### Long-Running Persistent Workflow Development in C#
**demand: 2** | Category: other
...
### Municipal Process Support
**demand: 2** | Category: other

### Onboarding Workflows
**demand: 2** | Category: Recruitment
Geautomatiseerde onboarding processen met taken en checklists

### DAG workflows Airflow
**demand: 2** | Category: other
...
### Omnichannel payment processing (online + in-store)
**demand: 2** | Category: other

### Ingest workflows Preservica
**demand: 2** | Category: other

### Intercompany processing
**demand: 2** | Category: other

### Quick Workflow Setup Without Code
**demand: 2** | Category: other

### Observable workflows Prefect
**demand: 2** | Category: other

### Child workflows Temporal
**demand: 2** | Category: other

### Presentation Processing
**demand: 2** | Category: other

### Event processing Activiti
**demand: 2** | Category: other

### Script tasks ProcessMaker
**demand: 2** | Category: other

### Form Processing
**demand: 2** | Category: other

### Screen builder ProcessMaker
**demand: 2** | Category: other

### Remediation workflows
**demand: 2** | Category: other

### AI-powered assessment workflows
**demand: 2** | Category: ai

### Quartz JDBC Clustering for High Availability Event Processing
**demand: 2** | Category: other
...
### SVS-UIT Grant Processing
**demand: 2** | Category: Case Management
Application and processing portal for subsidy-providing organizations

### Scheme-Based Workflows
**demand: 2** | Category: Case Management
Different workflow linked to each funding scheme for flexible process management

### Process-Driven Workflow
**demand: 2** | Category: Case Management
Guided workflow through all subsidy process steps with task-based navigation

### Process Configuration
**demand: 2** | Category: Extensibility
Fully configurable processes for both small and large subsidy workflows

### Virtual Thread Parallelization for Data Asset Ingestion
**demand: 2** | Category: other

### Plugin Unix Socket Directory Configuration for Restricted Environments
**demand: 2** | Category: release-v12.4.2
From 12.4.2 (2026-03-25)
...
### SW Hours Processing
**demand: 2** | Category: Workforce Management
Special handling of sheltered workshop (SW) employee hours and wage values.

### Power Automate workflows
**demand: 2** | Category: other

### Dataset Audit API for Missing File Detection
**demand: 2** | Category: governance

### Field-Level MIME Type Restriction for File Images
**demand: 2** | Category: document-management

### REST endpoint /supportedentities only supports english
**demand: 2** | Category: other

### MCP Server Administration UI with OAuth2 and API Key Authentication
**demand: 2** | Category: release-v17.2.0
From OpenProject 17.2.0 (2026-03-11)

### 150 processes digitalized
...
Discovered from GitHub issue in tailwindlabs/heroicons

### Localization Process Management
**demand: 1** | Category: other

### treatment-oriented workflows
**demand: 1** | Category: other
...
### batch-delete-process-instances
**demand: 1** | Category: general
Discovered from GitHub issue in [competitor]/[competitor]

### workflow-response-data
**demand: 1** | Category: general
Discovered from GitHub issue in appsmithorg/appsmith

### admin-process-filtering
**demand: 1** | Category: general
Discovered from GitHub issue in [competitor]/[competitor]

### process-coverage-diagram
**demand: 1** | Category: general
Discovered from GitHub issue in [competitor]/[competitor]
...
### Constructive Interaction Processes
**demand: 1** | Category: other

### Preapproved Clause Library for Negotiations
**demand: 1** | Category: other

### intuitive workflows
**demand: 1** | Category: other

### you to customize workflows
**demand: 1** | Category: other

### guard-railed workflows
**demand: 1** | Category: other

### Payment Processing
**demand: 1** | Category: other

### modules for dues processing
**demand: 1** | Category: other

### sophisticated processes (e
**demand: 1** | Category: other

### Secure Payment Processing
**demand: 1** | Category: other

### Participatory Process Hosting
**demand: 1** | Category: other

### Survey and Digital Submission Processing
**demand: 1** | Category: other
...
### Monitoring and Accreditation Process Management
**demand: 1** | Category: other

### Workflow Progress Tracking and Optimization
**demand: 1** | Category: other

### Progress Monitoring and Process Streamlining
**demand: 1** | Category: other

### Processing Efficiency and Error Reduction
**demand: 1** | Category: other

### legislative process efficiency
**demand: 1** | Category: other

### m ulti- processes inside
**demand: 1** | Category: other
...
### LLM-Generated Workflow Creation
**demand: 1** | Category: other

### Signature-Based Deliberative Process Initiation
**demand: 1** | Category: other

### Process Navigation and Contribution Visibility
**demand: 1** | Category: other
...
### Workflow Streamlining and Team Collaboration
**demand: 1** | Category: other

### AI-Powered Workflow Agent Creation
**demand: 1** | Category: ai
...
### Real-Time Geospatial and Environmental Data Processing
**demand: 1** | Category: other

### Technology Stack Analysis Integration
**demand: 1** | Category: other

### Update-Triggered Workflow Execution
**demand: 1** | Category: other
...
### workflow-activation-logging
**demand: unknown** | Category: general
Discovered from GitHub issue in keycloak/keycloak

### in-process-semantic-embeddings
**demand: unknown** | Category: general
Discovered from GitHub issue in [competitor]/[competitor]

### worklog-api-endpoint
**demand: unknown** | Category: general
Discovered from GitHub issue in makeplane/plane

### Filter Sales Process Optimization Items
**demand: unknown** | Category: other

### Auto-assemble dossier from case documents
**demand: unknown** | Category: other

### Bulk Actions in Sales Process Optimization
**demand: unknown** | Category: other

### Filter DPIA for CRM Processing Items
**demand: unknown** | Category: other

### Receive DPIA for CRM Processing Notifications
**demand: unknown** | Category: other

### Bulk Actions in DPIA for CRM Processing
**demand: unknown** | Category: other
...
### Download dataset as newline-delimited JSON for large-scale processing
**demand: unknown** | Category: other

### Receive notifications for BAG Mutation Processing
**demand: unknown** | Category: other
...
### View all integrations linked to a business process
**demand: unknown** | Category: other

### View outage impact on dependent processes
**demand: unknown** | Category: other

### View and prioritise the unprocessed correspondence queue
**demand: unknown** | Category: other

### View the process execution trace after a test run
**demand: unknown** | Category: other

### Detect sub-processors
**demand: unknown** | Category: other

### Flag software processing personal data
**demand: unknown** | Category: other

### Trigger emergency patch workflow
**demand: unknown** | Category: other

### Process incoming UBL/PEPPOL e-invoice
**demand: unknown** | Category: other

### Process subsidy reclaim and monitor repayment
**demand: unknown** | Category: other

### Receive and process inbound UBL/Peppol e-invoices
**demand: unknown** | Category: other
...
### Manage legal merger process
**demand: unknown** | Category: other

### Manage director appointment process
**demand: unknown** | Category: other

### process-assembly-nesting
**demand: unknown** | Category: general
Discovered from GitHub issue in [competitor]/[competitor]
