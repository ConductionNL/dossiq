...
and delivered beschikkingen SHALL be public. The portal contribution and
`#PublicStatus` SHALL show only public entries.
...
- **WHEN** the applicant opens the public status page
