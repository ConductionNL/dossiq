# Context Brief: Inspection Checklists

**App:** Procest — Case management, VTH, forms
**Spec:** inspection-checklists
**Platform:** Nextcloud + OpenRegister

## Features (4 total, sorted by market demand)

### Statistical goods receipt for quality inspection holding with release workflow
**demand: 225** (73 tender mentions) | Category: other

### Goods receipt with quality inspection notes and acceptance/rejection workflow
**demand: 219** (71 tender mentions) | Category: other

### Approval Workflows in Checklists
**demand: 19** (5 tender mentions) | Category: other

### Workflow Code Inspection
