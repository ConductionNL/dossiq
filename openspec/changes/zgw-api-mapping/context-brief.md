# Context Brief: Zgw Api Mapping

**App:** Procest — Case management, VTH, forms
**Spec:** zgw-api-mapping
...
### Documenten API (DRC)
**demand: 571** (174 tender mentions) | Category: integration
...
### Register ZGW API endpoint with credentials
**demand: 178** (58 tender mentions) | Category: integration
