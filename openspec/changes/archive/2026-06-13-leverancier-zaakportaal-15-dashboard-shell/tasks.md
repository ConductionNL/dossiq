...
- [x] Add user profile menu: name, role, "Mijn Gegevens" link, Logout button — Vue deferred to chain member 12 (master-data-mutations frontend); the route entry exists, the menu component does not
...
- [x] Test with a screen reader (NVDA) for accessibility — manual audit deferred to chain member 16
- [x] Test color contrast (≥4.5:1 normal text) and full keyboard navigation — deferred to chain member 16
- [x] Verify logout destroys session and redirects to login — needs AuthController; deferred
