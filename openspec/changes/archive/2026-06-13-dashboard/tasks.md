...
- [x] **V10**: Process Analytics (Doorlooptijd page) renders SLA %, breakdown table, throughput chart — needs live build
- [x] **V11**: Date-range preset updates all charts/KPIs — needs live build
- [x] **V12**: Workflow Board columns match non-final status types — needs live build
- [x] **V13**: Drag-and-drop advances status; failure reverts + toasts — needs live build (logic code-verified: optimistic move + revert + showError)
...
- [x] **V16**: Responsive grid at 768px — N/A for this build (SignaleringSection deferred, see T09); Woo panel + board use flex/responsive layout
