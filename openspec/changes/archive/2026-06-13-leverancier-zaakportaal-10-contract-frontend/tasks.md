...
- [x] Build `ContractDetail` page — Vue deferred to chain member 16; the list-level surface ships with the renewal-request action and the chip, which is the operator's primary read path
