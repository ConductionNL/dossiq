...
- [x] **T1** — Create `docs/Features/` folder with `_category_.json`
...
- [x] **T2** — Rename `docs/tutorials/` to `docs/user-guide/` and
...
- [x] **T3** — Create `docs/Technical/` folder with `_category_.json`
...
- [x] **T4** — Create `docs/UseCases/` stub section
...
- [x] **T5** — Create `docs/Integrations/` stub section
...
- [x] **T6** — Create `docs/index.md` with required frontmatter
...
- [x] **T7** — Create `docs/installation.md`
...
- [x] **T8** — Add `redocusaurus@^2.0.0` to the documentation site
  dependencies
...
- [x] **T9** — Wire `redocusaurus` plugin in `docusaurus.config.js`
...
- [x] **T10** — Add Dutch locale to `docusaurus.config.js`
...
- [x] **T11** — Sweep all `docs/**/*.md` files for em-dash characters
...
- [x] **T12** — Build the Docusaurus site locally and confirm
