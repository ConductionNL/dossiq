# Context Brief: Openregister Integration

**App:** Procest — Case management, VTH, forms
**Spec:** openregister-integration
**Platform:** Nextcloud + OpenRegister

## Features (1 total, sorted by market demand)

### Create a register object via REST API
**demand: 33** (7 tender mentions) | Category: integration
