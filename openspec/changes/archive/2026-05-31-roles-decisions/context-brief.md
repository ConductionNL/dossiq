# Context Brief: Roles Decisions

**App:** Procest — Case management, VTH, forms
**Spec:** roles-decisions
**Platform:** Nextcloud + OpenRegister

## Features (3 total, sorted by market demand)

### Multi-stakeholder evaluation committee workflow with role-based access and scoring
**demand: 548** (182 tender mentions) | Category: security

### Besluitvorming Workflows
**demand: 501** (128 tender mentions) | Category: other

### Assign organisational roles to process tasks
