...
- [x] P-1.2 Create `lib/Lifecycle/VoorstelSubmitGuard.php` with a single method
...
- [x] P-3.2 Create `lib/Lifecycle/HoorzittingAfzienGuard.php` with a single method
...
- [x] P-3.3 Create `lib/Lifecycle/BezwaarDeadlineGuard.php` with a single method
...
- [x] P-4.1 Remove the four `const STATUS_*` declarations from
...
- [x] P-4.2 Update all callers of `ParaferingService::STATUS_*` constants across the codebase
...
- [x] P-4.3 Remove or refactor direct `saveObject` calls in `ParaferingService` that set
...
- [x] P-5.1 Remove Application.php event listener registrations for any
...
- [x] P-5.2 Add `x-openregister-hooks` entries to the affected schemas in
...
- [x] P-6.1 Create `tests/Unit/Lifecycle/VoorstelLifecycleTest.php` covering:
...
- [x] P-6.2 Create `tests/Unit/Lifecycle/BezwaarLifecycleTest.php` covering:
...
- [x] P-6.3 Create `tests/Unit/Lifecycle/ParaferingServiceStepTest.php` confirming
