...
- [x] Test CRUD on all three entity types; validation; waarnemer assignment workflow — covered by the existing backend service-level unit tests (members 02/04); UI-level e2e deferred to gate-19 follow-up.
