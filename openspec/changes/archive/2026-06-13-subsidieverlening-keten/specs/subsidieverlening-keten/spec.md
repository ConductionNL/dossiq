...
Detailed requirements for subsidieverlening-keten: multi-year grant execution, AWB deadline binding, condition tracking, interim reports, settlement procedures, clawback workflows, evidence document lifecycle, EU staatssteun compliance, amendment procedures, and regulatory reporting. Delivered via OpenRegister schemas + services per ADR-022.
