...
Detailed requirements for the leges-heffingen capability: verordening import, automatic tariff calculation, variant selection, discount application, invoice creation, refunds, and audit trail. Delivered via OpenRegister schemas (`lib/Settings/register.d/30-leges.json`) plus Leges* services per ADR-022.
