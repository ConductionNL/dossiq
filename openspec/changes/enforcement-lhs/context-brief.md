# Context Brief: Enforcement Lhs

**App:** Procest — Case management, VTH, forms
**Spec:** enforcement-lhs
...
### Policy enforcement through workflow-embedded compliance checks
**demand: 663** (219 tender mentions) | Category: governance

### Toezicht & Handhaving
**demand: 390** (129 tender mentions) | Category: other

### Search within Process Enforcement Request
**demand: 234** (78 tender mentions) | Category: other

### View Process Enforcement Request overview
**demand: 81** (27 tender mentions) | Category: other

### Export Process Enforcement Request data
**demand: 68** (22 tender mentions) | Category: document-management

### Receive notifications for Process Enforcement Request
**demand: 24** (8 tender mentions) | Category: other

### Automated Data Policy Enforcement in Business Processes
