# Context Brief: Visual Workflow Editor

**App:** Procest — Case management, VTH, forms
**Spec:** visual-workflow-editor
**Platform:** Nextcloud + OpenRegister

## Features (26 total, sorted by market demand)

### Document Workflow Designer
**demand: 6220** (2073 tender mentions) | Category: document-management

### No-code workflow builder Kissflow
**demand: 510** (139 tender mentions) | Category: other

### Low-code workflow designer for creating custom approval processes without coding
**demand: 255** (81 tender mentions) | Category: other

### Search within Test BPMN Process in Staging Environment
**demand: 201** (67 tender mentions) | Category: other

### Visual Workflow Builder
**demand: 163** (54 tender mentions) | Category: other

### Visual Workflow Builder
**demand: 74** (23 tender mentions) | Category: other
...
**demand: 33** (7 tender mentions) | Category: other
...
### No-Code Custom Workflow Builder
...
Snel automatiseringen instellen vanuit sjabloonbibliotheek of eigen templates

### No-Code Workflow Builder
**demand: 2** | Category: AI & Automation
Powerful automation builder for alerts, approvals, and status updates without coding
