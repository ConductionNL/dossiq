# Context Brief: Process Step Configuration

**App:** Procest — Case management, VTH, forms
**Spec:** process-step-configuration
**Platform:** Nextcloud + OpenRegister

## Features (3 total, sorted by market demand)

### 100+ Pre-configured Workflow Steps
**demand: 219** (70 tender mentions) | Category: other

### Workflow steps with due dates
**demand: 171** (31 tender mentions) | Category: other

### See my case's progress through the process steps
