# Context Brief: Case Management

**App:** Procest — Case management, VTH, forms
**Spec:** case-management
**Platform:** Nextcloud + OpenRegister

## Features (33 total, sorted by market demand)

### Add Documents to Case Dossier
**demand: 6238** (2071 tender mentions) | Category: document-management

### Simple intake management with streamlined request forms and guided submission
**demand: 1616** (538 tender mentions) | Category: other

### Assign imported email to existing case dossier
**demand: 849** (283 tender mentions) | Category: other

### Zaakgericht werken integration
**demand: 812** (172 tender mentions) | Category: integration

### Zaaktype (Case Type) Management
**demand: 603** (199 tender mentions) | Category: other

### Zaaksysteem (Case System) Integration - KISS
**demand: 461** (151 tender mentions) | Category: integration

### Zaakgericht Werken
**demand: 387** (123 tender mentions) | Category: other

### Invoice intake with AI data extraction, review, and validation workflow
**demand: 343** (113 tender mentions) | Category: ai

### Search within Compile Complete Case Dossier
**demand: 201** (67 tender mentions) | Category: other

### Map schema to Zaakgericht Werken (ZGW) standard
**demand: 183** (61 tender mentions) | Category: other

### Create Subject Access Request case dossier
**demand: 174** (58 tender mentions) | Category: security

### Track case status via citizen portal
**demand: 121** (33 tender mentions) | Category: participation

### Automatically archive sent correspondence in case dossier
**demand: 102** (34 tender mentions) | Category: document-management

### Archive batch output to case dossiers
**demand: 102** (34 tender mentions) | Category: document-management

### Assign retention schedule to case dossier
**demand: 98** (32 tender mentions) | Category: scheduling

### Zaakgericht Werken
**demand: 87** (25 tender mentions) | Category: other

### Record approved destruction of case dossier
**demand: 66** (22 tender mentions) | Category: other

### View Compile Complete Case Dossier overview
**demand: 60** (20 tender mentions) | Category: other

### View all documents in case dossier
**demand: 33** (11 tender mentions) | Category: other

### Export Compile Complete Case Dossier data
**demand: 21** (7 tender mentions) | Category: document-management

### Multiple Intake Channels via Forms
**demand: 19** (6 tender mentions) | Category: other

### Map imported emails to case dossiers using subject/reference
**demand: 15** (5 tender mentions) | Category: other

### Create case dossier from template
**demand: 15** (5 tender mentions) | Category: document-management

### View the complete case dossier in one screen
**demand: 12** (4 tender mentions) | Category: other

### Intake Processing
**demand: 12** | Category: core
Counter intake with identity verification, completeness checks, and receipt printing

### Link related cases to dossier
**demand: 3** (1 tender mentions) | Category: other

### Receive notifications for Compile Complete Case Dossier
**demand: 3** (1 tender mentions) | Category: other
...
### Lock case dossier against modification on close
**demand: unknown** | Category: other

### Store approved letter in case dossier automatically
**demand: unknown** | Category: other
