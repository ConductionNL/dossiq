# Context Brief: Workflow Definition Model

**App:** Procest — Case management, VTH, forms
**Spec:** workflow-definition-model
**Platform:** Nextcloud + OpenRegister

## Features (7 total, sorted by market demand)

### Workflow Configuration
**demand: 538** (171 tender mentions) | Category: other

### No-code workflow configuration with drag-and-drop approval chain design
**demand: 402** (132 tender mentions) | Category: other

### Workflow template configuration
**demand: 148** | Category: governance bodies
Configure state machine workflows per governance body

### Custom Workflow Definition Validation
**demand: 94** (29 tender mentions) | Category: other

### Business Process Model Workflow Definition
