...
- [~] PR-3.1 Run the procest frontend in the dev environment (localhost:3000); verify — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] PR-3.2 Confirm that when openconnector is not installed (404 on the endpoint), — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] PR-4.1 Ensure the two valid address fixtures (Conduction HQ, Tilburg Stadhuis) — deferred to downstream cycle / fleet-wide adoption (handoff)
