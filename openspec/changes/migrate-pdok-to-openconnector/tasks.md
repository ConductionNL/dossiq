...
- [~] PR-3.1 DEFERRED — live-instance e2e. Run the procest frontend in the dev environment (localhost:3000); verify
...
- [~] PR-3.2 DEFERRED — live-instance e2e. Confirm that when openconnector is not installed (404 on the endpoint),
...
- [~] PR-4.1 DEFERRED — e2e fixture bootstrap. Ensure the two valid address fixtures (Conduction HQ, Tilburg Stadhuis)
