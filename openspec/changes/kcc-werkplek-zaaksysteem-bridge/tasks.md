...
- [~] **T03**: Create `src/views/settings/KccIntegrationSettings.vue` with admin form: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T04**: Create `lib/Service/ContactMomentService.php`: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T05**: Create `lib/Service/BurgerIdentificationService.php`: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T06**: Create `lib/Service/BelplanRoutingService.php`: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T07**: Create `lib/Service/QuickActionService.php`: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T08**: Create `lib/Service/DoorverbindingService.php`: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T09**: Create `lib/Service/SentimentService.php`: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T10**: Create `lib/Service/CaseVoorbledService.php`: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T11**: Create `lib/Controller/ContactMomentController.php`: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T12**: Create `lib/Controller/BelplanController.php`: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T13**: Create `lib/Controller/SpecialistBeschikbaarheidController.php`: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T14**: Update `appinfo/routes.php`: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T15**: Create `lib/BackgroundJob/SentimentAnalysisJob.php` (TimedJob): — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T16**: Create `lib/BackgroundJob/SpecialistBeschikbaarheidRefreshJob.php` (TimedJob): — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T17**: Create `lib/BackgroundJob/IdentificationReviewJob.php` (TimedJob): — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T18**: Update `lib/Listener/ActivitiesEventSubscriber.php`: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T19**: Create `lib/Listener/SentimentEventSubscriber.php`: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T20**: Create seed data script `lib/Migrations/Version20XX_seedKccDefaults.php`: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **V01**: Schemas load correctly: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **V02**: Routes resolve before SPA catch-all: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **V03**: Burger identification end-to-end: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **V04**: Case-voorblad auto-opens and displays correctly: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **V05**: Quick-action "Status terugkoppelen" end-to-end: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **V06**: Quick-action "Nieuwe zaak" end-to-end: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **V07**: Quick-action "Klacht registreren" end-to-end: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **V08**: Belplan routing end-to-end: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **V09**: Sentiment detection end-to-end: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **V10**: Doorverbinding context-snapshot end-to-end: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **V11**: Klantreis timeline aggregation: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **V12**: Settings persistence: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **D01**: Update README.md or ARCHITECTURE.md: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **D02**: Create API documentation (OpenAPI/Swagger): — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **D03**: Create admin guide: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T-Functional**: Functional testing suite: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T-Performance**: Performance baseline: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T-Security**: Security review: — deferred to downstream cycle / fleet-wide adoption (handoff)
...
- [~] **T-Integration**: Integration testing with pipelinq mock: — deferred to downstream cycle / fleet-wide adoption (handoff)
