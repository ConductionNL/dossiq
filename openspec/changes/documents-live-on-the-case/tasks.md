...
- [x] 1.1 `lib/Settings/register.d/70-document-zaakdossier.json`: add the optional
...
- [x] 1.2 `lib/Service/Zaakdossier/DocumentProjectionService.php`: `projectNode`,
...
- [x] 1.3 `lib/Listener/CaseFolderNodeListener.php` on `NodeCreatedEvent`,
...
- [x] 2.1 `lib/Controller/ZrcController.php`: after a created
...
- [x] 2.2 `lib/Service/Zaakdossier/DossierUploadHandler.php` and
...
- [x] 3.1 `lib/Repair/MoveDocumentsIntoCaseFolders.php`, registered under
