# Context Brief: Vth Case Type Seed

**App:** Procest — Case management, VTH, forms
**Spec:** vth-case-type-seed
**Platform:** Nextcloud + OpenRegister

## Features (13 total, sorted by market demand)

### Search within Design Permit Processing Workflow
**demand: 599** (199 tender mentions) | Category: other

### View Design Permit Processing Workflow overview
**demand: 466** (154 tender mentions) | Category: other

### Export Design Permit Processing Workflow data
**demand: 442** (146 tender mentions) | Category: document-management

### Search within Process Event Permit
**demand: 237** (79 tender mentions) | Category: other

### View Process Event Permit overview
**demand: 96** (32 tender mentions) | Category: other

### Export Process Event Permit data
**demand: 75** (25 tender mentions) | Category: document-management

### Receive notifications for Process APV Permit Application
**demand: 33** (11 tender mentions) | Category: other

### Model BPMN permit process
**demand: 21** (5 tender mentions) | Category: other

### VTH Permit Application Processing
**demand: 19** (3 tender mentions) | Category: other

### Environmental Permit Processing
**demand: 18** (2 tender mentions) | Category: other

### Receive notifications for Process Event Permit
**demand: 15** (5 tender mentions) | Category: other

### Permit processing GeoVacs
**demand: 13** (1 tender mentions) | Category: other

### Wabo Permit Processing
**demand: 13** (1 tender mentions) | Category: other
