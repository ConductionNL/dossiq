...
A view that renders from the store subscribes to changes in what it renders. A
handler watching the workflow board sees somebody else's move without pressing
reload.
