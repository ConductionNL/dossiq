...
# procest-procurement-supplier-management Specification

## Purpose
Define the supplier (vendor) management surface for procest as case
...
lifecycle, performance, portal-RBAC, and notifications reusing procest's
