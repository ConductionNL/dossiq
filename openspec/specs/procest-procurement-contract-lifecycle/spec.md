...
# procest-procurement-contract-lifecycle Specification

## Purpose
Define contract lifecycle management for procest: contracts as an
...
procest's workflow-engine + parafering abstractions (ADR-022/031).
## Requirements
