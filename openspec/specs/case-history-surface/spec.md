# case-history-surface Specification

## Purpose

A case keeps one change history, and you read it on the case. The history is a
sidebar tab on the case page rather than a page of its own, so there is one
