# zgw-brc Specification

## Purpose

A ZGW Besluit resolves to decidiq's Decision. dossiq stops keeping a besluit of
its own where decidiq already holds one. Existing besluiten move only when
somebody asks for the migration, never as a side effect of an upgrade.
