...
/**
 * Average Processing Time Dashboard Widget
 *
 * Displays average case processing time metrics.
 *
 * @category Dashboard
...
/**
 * Dashboard widget showing average processing time.
 *
 * @spec openspec/changes/doorlooptijd-dashboard/tasks.md#task-10
 */
class AverageProcessingTimeWidget implements IWidget
{
    /**
     * Constructor.
     *
    ...
    {
        return 'procest_avg_processing_time_widget';
    ...
    {
        return $this->l10n->t('Average Processing Time');
