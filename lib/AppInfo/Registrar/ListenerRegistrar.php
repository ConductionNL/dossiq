 ...
 * listeners, the termijn + decision workflow listeners, and the cross-app
 * listeners another app's events drive. It owns no registration itself, only
 * which specialised registrars run.
 *
 * @category AppInfo
