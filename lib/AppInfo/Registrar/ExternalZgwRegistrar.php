...
/**
 * Dossiq external-ZGW / ZTC registrar.
 *
 * Binds the cross-municipality ZGW hand-off seam and the ZTC / Catalogi-API
 * zaaktype-resolution seam. Both are dormant log-only aliases: dossiq declares
...
use OCA\Dossiq\Service\External\Zgw\LogZgwExternalAdapter;
use OCA\Dossiq\Service\External\Zgw\ZgwExternalAdapterInterface;
use OCA\Dossiq\Service\External\Ztc\LogZtcCatalogiAdapter;
use OCA\Dossiq\Service\External\Ztc\ZtcCatalogiAdapterInterface;
...
class ExternalZgwRegistrar {
	 ...
	 * submission. Dossiq contributes the mapping declaratively (tmloDefaults).
	 *
