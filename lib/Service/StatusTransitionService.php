...
class StatusTransitionService {
	...
	private function recordAndDispatch(
		...
		$actions = array_merge(
			$this->statusChecklist->actionsFor(statusTypeId: $toStatus, case: $case, userId: $userId),
	...
	public function executeFreeForm(string $caseId, string $toStatusId, ?string $comment, ?string $userId = null): array {
		...
		$dispatched = $this->sideEffectDispatcher->dispatch(
			actions: $this->statusChecklist->actionsFor(statusTypeId: $toStatusId, case: $case, userId: $userId),
			case: $case,
			transitionContext: [
				'fromStatus' => $currentId,
				'toStatus' => $toStatusId,
