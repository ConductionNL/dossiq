...
/**
 * Dossiq AI prompt factory.
 *
 * Every prompt template dossiq sends to the configured AI model, in one place:
 ...
 *
 * Split out of {@see \OCA\Dossiq\Service\AiService} so the wording of what we
