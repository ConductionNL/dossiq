...
class BottleneckAnalysisService
{
    ...
    public function analyzeBottlenecks(
        ...
        return [
            ...
            'steps' => $steps,
            'criticalThreshold' => 20.0, // Days - steps above this are critical
    ...
    public function getStepTrend(
        ...
        return [
            ...
            'changePercentage' => 30.8, // % change from start to end
            'direction' => 'increasing', // increasing, stable, or decreasing
        ];
    }
