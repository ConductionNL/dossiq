...
$extra = [
    ...
    ['name' => 'caseType#publish',         'url' => '/api/case-types/{id}/publish',          'verb' => 'POST'],
        // The effective blueprint of a case type (its own rows merged with its
        // parent's) and the validate-then-publish gesture. Both are keyed on the
        // case type rather than on a definition package, so they sit under
        // /api/case-types.
    ['name' => 'caseDefinition#blueprint', 'url' => '/api/case-types/{id}/blueprint', 'verb' => 'GET'],
    ['name' => 'caseDefinition#publish',   'url' => '/api/case-types/{id}/publish',   'verb' => 'POST'],
