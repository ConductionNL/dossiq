...
// Keep the base plugins from @nextcloud/webpack-vue-config (NodePolyfillPlugin
// supplies the `process` shim, IgnorePlugin handles moment locales, etc.).
// Drop only the upstream VueLoaderPlugin so we don't end up with two instances,
// then append our app-specific defines.
webpackConfig.plugins = [
	...webpackConfig.plugins.filter(p => !(p instanceof VueLoaderPlugin)),
	new VueLoaderPlugin(),
